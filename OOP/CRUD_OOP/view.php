                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            ...
                            // Periksa apakah hasil dari tampil_data() adalah array
                            $data = $db->tampil_data();
                            ...
                            <tr>
                                <td><?php echo $no++; ?></td>
                                <!-- Periksa apakah $x adalah array sebelum mengakses elemennya -->
                                <td><?php echo isset($x['nama']) ? $x['nama'] : ''; ?></td>
                                <td><?php echo isset($x['umur']) ? $x['umur'] : ''; ?></td>
                                <td><?php echo isset($x['jenis_k']) ? $x['jenis_k'] : ''; ?></td>
                                <td>
                                    <a href="Edit.php?id=<?php echo isset($x['id']) ? $x['id'] : ''; ?>&aksi=edit"
                                        class="btn btn-success">
                                        <i class="fa fa-user-edit mr-2"></i>Edit
                                    </a>
                                    <a href="app/proses.php?id=<?php echo isset($x['id']) ? $x['id'] : ''; ?>&aksi=hapus"
